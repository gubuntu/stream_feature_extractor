...
project = 'StreamFeatureExtractor'
...
latex_documents = [
  ('index', 'StreamFeatureExtractor.tex', 'StreamFeatureExtractor Documentation',
...
man_pages = [
    ('index', 'TemplateClass', 'StreamFeatureExtractor Documentation',
     ['Kartoza (Pty) Ltd.'], 1)
]
